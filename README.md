...
| `starops/cross-product-inspection-summary-sop` | [跨产品巡检汇总最佳实践](https://sls.aliyun.com/doc/starops/practices/cross-product-inspection-summary/article.html) | `starops/demo/starops-best-practice/cross-product-inspection-summary/docs/cross-product-inspection-summary-sop.tar.gz` |
