...
| `starops/umodel-metric-entity-sop` | [UModel 指标语义与实体拓扑](https://sls.aliyun.com/doc/starops/practices/umodel-metric-entity/article.html) | `starops/demo/starops-best-practice/umodel-metric-entity/docs/umodel-metric-entity-sop.tar.gz` |
