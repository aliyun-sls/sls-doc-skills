...
| `umodel/devops-verification` | [DevOps 跨域追因建模](https://sls.aliyun.com/doc/starops/practices/devops-code-to-runtime/article.html) | `starops/demo/starops-best-practice/devops-code-to-runtime/docs/devops-verification.tar.gz` |
...
| `starops/cross-product-inspection-summary-sop` | [多云产品融合巡检最佳实践](https://sls.aliyun.com/doc/starops/practices/cross-product-inspection-summary/article.html) | `starops/demo/starops-best-practice/cross-product-inspection-summary/docs/cross-product-inspection-summary-sop.tar.gz` |
